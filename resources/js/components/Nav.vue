<template>
    <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
            ...
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search"
                           class="rounded-full pl-8 w-56 h-8 bg-gray-200 focus:outline-none focus:shadow-outline text-sm"
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/"
                         :class="{ 'px-6': true, 'border-b-2': true, 'border-blue-500': activePage === 'home', 'border-white': activePage !== 'home', 'h-full': true, 'flex items-center': true }">
            ...
            <router-link :to="'/users/' + authUser.data.user_id"
                         :class="{ 'px-6': true, 'border-b-2': true, 'border-blue-500': activePage === 'profile', 'border-white': activePage !== 'profile', 'h-full': true, 'flex items-center': true }">
            ...
            <router-link to="/"
                         :class="{ 'px-6': true, 'border-b-2': true, 'border-blue-500': activePage === 'message', 'border-white': activePage !== 'message', 'h-full': true, 'flex items-center': true }">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-5 h-5">
                    <path
